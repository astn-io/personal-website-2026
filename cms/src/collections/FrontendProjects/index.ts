...
export const FrontendProjects: CollectionConfig = {
          ...
          fields: [
            {
              ...
              type: 'text',
              admin: {
                description: 'URL to the source code repository (e.g. GitHub)',
              },
            },
            {
              name: 'demoUrl',
            ...
            },
            {
              ...
              type: 'text',
              admin: {
                description: 'URL to the Frontend Mentor challenge page',
              },
            },
          ],
        },
